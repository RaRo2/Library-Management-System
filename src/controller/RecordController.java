...
public class RecordController extends Controller<Library>{
    ...
    @FXML Button patBtn;
    @FXML Text statusTxt;
    @FXML ListView<Book> cbbLv;
    @FXML ListView<Book> bhLv;
    ...
    @FXML private void handleShowRecord() {
        statusTxt.setText(getPatron().getName() + " Selected");
        cbbLv.setItems(getPatron().currentlyBorrowed());
        bhLv.setItems(getPatron().borrowingHistory());
    }
